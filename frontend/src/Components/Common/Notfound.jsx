...
const Notfound = () => {
    return (
        <div className='w-full flex justify-center items-center flex-col empty-cart pt-20'>
            ...
            <button className='mb-2 mt-6 border border-pink-600 px-4 py-0.5 text-lg text-pink-600 bg-white font-semibold transition-all ease-in-out duration-700 hover:text-white hover:bg-pink-600'> <i className="fa-solid fa-arrow-left pr-2"></i> Go back</button>
