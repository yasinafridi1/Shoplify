        ...
        <>
            <section className='flex justify-center items-center flex-col'>
                <div className='home flex justify-center items-center flex-col'>
                    ...
                    <button className='mt-4 xsm:mt-6'><Link className='px-4 text-xl py-2 xsm:px-6 xsm:py-2 bg-pink-600 text-white font-bold transition ease-in-out duration-500 btn-login' to='/product'>Shop Now</Link></button>
                </div>
